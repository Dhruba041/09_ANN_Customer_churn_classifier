...
#model = load_model("best_model_keras_bank_churn_ann.keras")  #new method from file

model = keras.models.load_model("best_model_keras_bank_churn_ann.keras") #for keras == 3.15.0
